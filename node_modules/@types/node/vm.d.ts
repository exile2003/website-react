 ...
 *
 * A common use case is to run the code in a different V8 Context-2. This means
...
declare module 'vm' {
    ...
    interface CreateContextOptions {
         ...
         * @default 'VM Context-2 i' Where i is an ascending numerical index of the created context.
         */
